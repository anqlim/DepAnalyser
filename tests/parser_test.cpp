...
TEST(CppParserTest, FindsLocalIncludes) {
    ...
    auto deps = parser.parse("tests/fixtures/cpp/main.cpp", "tests/fixtures/cpp");
...
TEST(CppParserTest, EmptyFile) {
    Parsing::CppParser parser;
    auto deps = parser.parse("tests/fixtures/cpp/utils.h", "tests/fixtures/cpp");
    EXPECT_TRUE(deps.empty());
}

TEST(CppParserTest, FileNotFound) {
    Parsing::CppParser parser;
    auto deps = parser.parse("tests/fixtures/cpp/nonexistent.cpp", "tests/fixtures/cpp");
    EXPECT_TRUE(deps.empty());
}
...
TEST(PythonParserTest, FindsRelativeImports) {
    ...
    auto deps = parser.parse("tests/fixtures/python/main.py", "tests/fixtures/python");
    EXPECT_EQ(deps.size(), 2);
}
...
TEST(PythonParserTest, FileNotFound) {
    Parsing::PythonParser parser;
    auto deps = parser.parse("tests/fixtures/python/nonexistent.py", "tests/fixtures/python");
    EXPECT_TRUE(deps.empty());
}
...
TEST(JavaParserTest, FindsImports) {
    ...
    auto deps = parser.parse("tests/fixtures/java/Main.java", "tests/fixtures/java");
    EXPECT_EQ(deps.size(), 2);
}
...
TEST(JavaParserTest, FileNotFound) {
    Parsing::JavaParser parser;
    auto deps = parser.parse("tests/fixtures/java/Nonexistent.java", "tests/fixtures/java");
    EXPECT_TRUE(deps.empty());
}
...
TEST(JsParserTest, FindsRelativeImports) {
    ...
    auto deps = parser.parse("tests/fixtures/js/main.js", "tests/fixtures/js");
...
TEST(JsParserTest, FileNotFound) {
    Parsing::JsParser parser;
    auto deps = parser.parse("tests/fixtures/js/nonexistent.js", "tests/fixtures/js");
    EXPECT_TRUE(deps.empty());
}
...
TEST(GoParserTest, FindsRelativeImports) {
    ...
    auto deps = parser.parse("tests/fixtures/go/main.go", "tests/fixtures/go");
    EXPECT_EQ(deps.size(), 2);
}
...
TEST(GoParserTest, FileNotFound) {
    Parsing::GoParser parser;
    auto deps = parser.parse("tests/fixtures/go/nonexistent.go", "tests/fixtures/go");
    EXPECT_TRUE(deps.empty());
}
